...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.multi_acts_path2 = 'data/multi-woz-processed/multi_act_reference_rank_50_Random.json'
        ...
        self.copy_pvaspn = False
        self.copy_act = True
        self.copy_usdx = True
        self.cand_act_gate = False
        self.use_pv_resp = False
        #Training setting
        self.rs = False
        self.rs_p = 0.6
        self.multi_act_fusion = False
        self.copy_cand_act = False
        self.gate_per_batch = []
        self.grandient_accumulation_steps=1
        #修复db pointer中可能的泄露问题
        self.fix_db_pointer = False
    def __str__(self):
        s = ''
