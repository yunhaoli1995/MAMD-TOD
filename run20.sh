python model.py -mode train -cfg seed=777 cuda_device=0 exp_no=sd777FTTFFFT_an5_bs80_eopch60_lr7e-3_shuffle_0.2_act9 batch_size=80 \
    multi_acts_path=data/multi-woz-processed/multi_act_reference_rank_50.json \
    multi_acts_path2=data/multi-woz-processed/multi_act_reference_rank_50_Random.json \
